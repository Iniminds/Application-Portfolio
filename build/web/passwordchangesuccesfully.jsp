...
<html>
    ...
    <body background="homepage_bg.jpg">
        ...
        <p align="center"><img src="lets begin.jpg" width="600" height="200">
            <br><br><font size="5"><b>ESSAR APPLICATION PORTFOLIO</b></font><br>
        </p>
        <h3 align="center">Your Password Change Succesfully</h3>
        <p align="center"><a href="acctry.jsp">Create An Account</a></p>
