 ...
 * @author admin
 */
@WebServlet(name="FileToDatabase", urlPatterns={"/FileToDatabase"})
public class FileToDatabase extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            response.sendRedirect("sendsuccesfully.jsp");
            
            /* TODO output your page here
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FileToDatabase</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FileToDatabase at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } 
