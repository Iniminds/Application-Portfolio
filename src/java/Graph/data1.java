 ...
 * @author admin
 */
@WebServlet(name="data1", urlPatterns={"/data1"})
public class data1 extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    conn.close();
         ...
         if(s1.equals("pie"))
         {
         response.sendRedirect("graphpie.jsp");
            }
 else if(s1.equals("Column"))
         {
           response.sendRedirect("graphcolumn.jsp");
 }
 else if(s1.equals("pareto"))
         {
             response.sendRedirect("graphpareto.jsp");
 }
 else if(s1.equals("bar"))
         {
             response.sendRedirect("graphbar.jsp");
        }
        else
         {
             response.sendRedirect("graphdoughnut.jsp");
        }
