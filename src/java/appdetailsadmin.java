 ...
 * @author admin
 */
@WebServlet(name="appdetailsadmin", urlPatterns={"/appdetailsadmin"})
public class appdetailsadmin extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.print("<p align=center><img src=lets_begin.jpg width=600 height=200></p>");
            out.print("<p class=p9><a href=homepageadmin.jsp>Goto Homepage</a><br><br><a href=logout.jsp>"+"Logout"+"</a></p>");
