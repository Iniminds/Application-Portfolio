...
.p2{
    ...
    <body background="homepage_bg.jpg">
        ...
        <h3 align="center">Your Application Data add in Database.</h3>
        <fieldset>
        <form action="appdetailsadmindata" method="post">
            ...
            Last Modified Date:<input type="text" name="lastMD" size="30"><br><br>
            Update Date:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="Updatedate" size="30"><br><br>
