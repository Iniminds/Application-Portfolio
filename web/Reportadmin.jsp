...
.p6
{
    ...
    <body background="homepage_bg.jpg">
      ...
      <p class="p6"><a href="homepageadmin.jsp">Goto Homepage</a><br><br><a href="logout.jsp">Logout</a></p>
      
       <h3 class="p5">  <form action="Reportadmin" method="post" align="center">

        <input type="radio" name="r1" value="report" checked="checked"/>Generate Report<br>
        <input type="radio" name="r1" value="notice"/>Generate Notice<br><br>
