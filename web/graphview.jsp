...
.p8
{
    ...
    <body background="homepage_bg.jpg">
        ...
        <font size="3"><p class="p8"><a href="homepage.jsp">Goto Homepage</a><br><br><a href="logout.jsp">Logout</a></p></font><br>
        <h3 align="center">How many Application working in particular Platform?</h3>
<form name="employee" action="data1" method="post" class="p1">
