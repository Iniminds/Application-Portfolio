...
.p9
{
   ...
   if(reg.test(address) == false) {
    ...
    <body background="homepage_bg.jpg">
         ...
         <font size="3"> <p class="p9"><a href="homepageadmin.jsp">Goto Homepage</a><br><br>
                 <a href="Reportsadmin.jsp">Inbox Report</a>
          <br><br>
                 <a href="logout.jsp">Logout</a></p></font>



        <form class="y" id="form_id" action="FileToDatabaseadmin" method="post">
